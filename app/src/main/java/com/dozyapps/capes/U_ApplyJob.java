...
public class U_ApplyJob extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.u_activity_apply_job);
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (qual.equalsIgnoreCase(requal) && inexp >= inreqexp) {
                                U_JobList applyjob = new U_JobList();
                                ...
                                Toast.makeText(U_ApplyJob.this, "Job Applied", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(U_ApplyJob.this, "Not Eligible For This Job", Toast.LENGTH_SHORT).show();
                            }
