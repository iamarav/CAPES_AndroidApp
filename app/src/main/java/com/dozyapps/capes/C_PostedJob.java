...
public class C_PostedJob extends AppCompatActivity {

    RecyclerView postedjobrcv;
    PostedjobAdapter postedjobadapter=new PostedjobAdapter();
    ArrayList<C_JobList> postedjoblist = new ArrayList<>();
    DatabaseReference myRef;
    FirebaseAuth mAuth;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.c_activity_posted_job);
        ...
        RecyclerView.LayoutManager manager = new LinearLayoutManager(C_PostedJob.this);
    ...
    public class PostedjobAdapter extends RecyclerView.Adapter<PostedjobViewHolder>{
        ...
        public void onBindViewHolder(@NonNull final PostedjobViewHolder holder, int position) {
            final C_JobList list=postedjoblist.get(position);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(C_PostedJob.this, C_AppliedCandidates.class);
            ...
            holder.deljob.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(C_PostedJob.this, "JOB DELETED", Toast.LENGTH_SHORT).show();
