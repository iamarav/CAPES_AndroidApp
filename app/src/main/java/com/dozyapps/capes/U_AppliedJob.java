...
public class U_AppliedJob extends AppCompatActivity {
    ...
    ArrayList<U_JobList> applied_joblist = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.u_activity_applied_job);
        ...
        RecyclerView.LayoutManager manager = new LinearLayoutManager(U_AppliedJob.this);
        ...
        myRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(U_AppliedJob.this, "Error", Toast.LENGTH_SHORT).show();
    ...
    public class AppliedjobAdapter extends RecyclerView.Adapter<AppliedjobViewHolder>{
        ...
        public AppliedjobViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View v=inflater.inflate(R.layout.u_applied_job_list,parent,false);
        ...
        public void onBindViewHolder(AppliedjobViewHolder holder, int position) {
            final U_JobList list=applied_joblist.get(position);
