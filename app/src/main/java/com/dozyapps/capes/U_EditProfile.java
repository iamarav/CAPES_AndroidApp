...
public class U_EditProfile extends AppCompatActivity implements View.OnClickListener{
   ...
   ProgressBar progressBar,videoprogressBar;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.u_activity_edit_profile);
        mAuth = FirebaseAuth.getInstance();
        FirebaseUser user = mAuth.getCurrentUser();
        mStorageReference= FirebaseStorage.getInstance().getReference();

        mDatabasereference=FirebaseDatabase.getInstance().getReference((U_Constants.DATABASE_PATH_UPLOADS+"/"+user.getUid()+"/"));
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(U_EditProfile.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private void SaveProfile() {
        ...
        U_SaveUserProfile sp=new U_SaveUserProfile(name,city,address,pincode
        ...
        Toast.makeText(U_EditProfile.this, "success", Toast.LENGTH_SHORT).show();
        Toast.makeText(U_EditProfile.this, "Please Upload CV", Toast.LENGTH_SHORT).show();
    ...
    private void uploadPdfFile(Uri data) {
        ...
        StorageReference sRef = mStorageReference.child(U_Constants.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(U_EditProfile.this, "CV Uploaded", Toast.LENGTH_SHORT).show();

                        U_UploadCv upload = new U_UploadCv( taskSnapshot.getDownloadUrl().toString());
    ...
    private void uploadVideoFile(Uri data) {
        ...
        progressBar.setVisibility(View.VISIBLE);
        StorageReference sRef = mStorageReference.child(U_Constants.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".mp4");
        sRef.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    @SuppressWarnings("VisibleForTests")
                    @Override
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(U_EditProfile.this, "Video Uploaded", Toast.LENGTH_SHORT).show();

                        U_UploadVideoCv upload = new U_UploadVideoCv( taskSnapshot.getDownloadUrl().toString());
                        mDatabasereference.child("videocv").setValue(upload);
                        Intent i=new Intent(U_EditProfile.this, U_ProfileActivity.class);
                        startActivity(i);
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
