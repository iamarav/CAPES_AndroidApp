...
public class U_ShowProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.u_activity_show_profile);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(U_ShowProfile.this, "Error", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View v) {
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(videocv!=null) {
                                Intent intent = new Intent(U_ShowProfile.this, U_ShowVideoCv.class);
                                intent.putExtra("videourl", videocv);
                                startActivity(intent);
                            }else {
                                Toast.makeText(U_ShowProfile.this, "No Video Cv", Toast.LENGTH_SHORT).show();
                            }
