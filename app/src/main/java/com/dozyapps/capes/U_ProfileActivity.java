...
FirebaseAuth mAuth;
    ...
    ArrayList<U_JobList> joblist=new ArrayList<>();
    CheckBox it,nonit;

    @Override
    protected void onCreate(final Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.u_profile_activity);
        ...
        checkRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (name==null){
                    Intent intent=new Intent(U_ProfileActivity.this, U_EditProfile.class);
        ...
        RecyclerView.LayoutManager manager = new LinearLayoutManager(U_ProfileActivity.this);
        ...
        referesh.setOnClickListener(new View.OnClickListener() {
            ...
            myRef.addChildEventListener(new ChildEventListener() {
                ...
                @Override
                public void onCancelled(DatabaseError databaseError) {
                    Toast.makeText(U_ProfileActivity.this, "Error", Toast.LENGTH_SHORT).show();
                }
            });
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (s.isEmpty()) {
                    Toast.makeText(U_ProfileActivity.this, "No Result", Toast.LENGTH_SHORT).show();
    ...
    private void filterjob(String text){
        ...
        ArrayList<U_JobList> filteredlist=new ArrayList<>();

        for(U_JobList item : joblist){
    ...
    public  class MyAdapter extends RecyclerView.Adapter<MyViewHolder>{
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View v=inflater.inflate(R.layout.u_joblist,parent,false);
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
                final U_JobList list=joblist.get(position);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                            ...
                            Intent intent=new Intent(U_ProfileActivity.this, U_ApplyJob.class);
        ...
        public void filterlist(ArrayList<U_JobList> filteredlist){
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.u_profile, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_edit)
            startActivity(new Intent(this, U_EditProfile.class));
        else if (id == R.id.nav_show)
            startActivity(new Intent(this, U_ShowProfile.class));
        else if (id == R.id.nav_appliedjob)
            startActivity(new Intent(U_ProfileActivity.this, U_AppliedJob.class));
        else if (id==R.id.nav_start_quiz)
            startActivity(new Intent(U_ProfileActivity.this, U_QUIZ_Verify.class));
