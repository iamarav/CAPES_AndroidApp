...
public class C_UploadJob extends AppCompatActivity {
...
TextView jobdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c_activity_upload_job);
       ...
       ImageView date=(ImageView)findViewById(R.id.date);
        ArrayAdapter<String> expadapter=new ArrayAdapter<>(C_UploadJob.this,android.R.layout.simple_list_item_1,exp);
        expspinner.setAdapter(expadapter);
        ArrayAdapter<String> jobtypeadapter=new ArrayAdapter<>(C_UploadJob.this,android.R.layout.simple_list_item_1,jobtype);
        jobtypespinner.setAdapter(jobtypeadapter);

        ArrayAdapter<String> ugadapter=new ArrayAdapter<>(C_UploadJob.this,android.R.layout.simple_list_item_1,ugcourse);
        ug.setAdapter(ugadapter);


        ArrayAdapter<String> pgadapter=new ArrayAdapter<>(C_UploadJob.this,android.R.layout.simple_list_item_1,pgcourse);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(C_UploadJob.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                C_PostJob pj=new C_PostJob(name,jobid,location,jobdescription,experience,jobqualification,skills,salary,contact,emailid,jobtype,date,uid);
                ...
                try {
                    ...
                    Toast.makeText(C_UploadJob.this, "Error", Toast.LENGTH_SHORT).show();
                }

                Toast.makeText(C_UploadJob.this, "Job Posted", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
