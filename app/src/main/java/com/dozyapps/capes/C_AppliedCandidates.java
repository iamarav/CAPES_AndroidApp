...
public class C_AppliedCandidates extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c_activity_applied_candidates);
        ...
        RecyclerView.LayoutManager manager=new LinearLayoutManager(C_AppliedCandidates.this);
       ...
       myRef.addListenerForSingleValueEvent(new ValueEventListener() {
           ...
           public void onCancelled(DatabaseError databaseError) {
               Toast.makeText(C_AppliedCandidates.this, "Error", Toast.LENGTH_SHORT).show();
           }
       });
    ...
    public class  AppliedcandiAdapter extends RecyclerView.Adapter<MyViewHolder>{
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View v = inflater.inflate(R.layout.c_appliedcandidatelist, parent, false);
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            holder.downvideocv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (videocv!=null) {
                        Intent intent = new Intent(C_AppliedCandidates.this, C_ShowVideoCv.class);
                        intent.putExtra("videocv", videocv);
                        startActivity(intent);
                    }else {
                        Toast.makeText(C_AppliedCandidates.this, "No Video Cv", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
