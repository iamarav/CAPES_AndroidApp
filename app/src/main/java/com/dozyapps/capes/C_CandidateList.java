...
public class C_CandidateList {
    ...
    public C_CandidateList(String achievements, String address, String certifications, String city, String dob, String email, String name, String pgcourse, String pgmarks, String pgyear, String pincode, String sex, String skills, String ugcourse, String ugmarks, String ugyear, String workexp, String xiimarks, String xiiyear, String xmarks, String xyear) {
        this.achievements = achievements;
        this.address = address;
        this.certifications = certifications;
        this.city = city;
    ...
    public C_CandidateList(String cv) {
        this.cv = cv;
    }
