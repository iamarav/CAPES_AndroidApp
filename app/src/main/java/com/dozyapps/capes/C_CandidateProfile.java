...
public class C_CandidateProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c_activity_candidate_profile);
        ...
        downloadcv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    try {
                        ...
                        String error="No Cv";
                        Toast.makeText(C_CandidateProfile.this, error, Toast.LENGTH_SHORT).show();
                    }
        ...
        showvideocv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    if (videocv!=null) {
                        Intent intent = new Intent(C_CandidateProfile.this, C_ShowVideoCv.class);
                        intent.putExtra("videocv", videocv);
                        startActivity(intent);
                    }else {
                        Toast.makeText(C_CandidateProfile.this, "No Video Cv", Toast.LENGTH_SHORT).show();
                    }
